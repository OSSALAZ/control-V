...
console.log('%c🚗 Control Vial - San Pedro Garza García', 'font-size: 20px; font-weight: bold; color: #005A9C;');
console.log('%cSistema inteligente de gestión vehicular', 'font-size: 14px; color: #5F6368;');
console.log('%c© 2025 Municipio de San Pedro Garza García', 'font-size: 12px; color: #80868B;');
